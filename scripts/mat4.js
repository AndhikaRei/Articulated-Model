 ...
 * @returns {number[]} vector a - vector b
 */
...
/**
 * @description function to normalize vector.
...
/**
 * @description Do cross product of two vectors.
 * @param {number[]} a - vector a
 * @param {number[]} b - vector b
 * @returns {number[]} cross product of two vectors
 */
function cross(a, b) {
